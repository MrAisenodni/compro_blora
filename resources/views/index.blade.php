...
@section('content')
        ...
        <div class="container">
            ...
            <div class="col-12">
                ...
                <div class="member">
                    ...
                    <img src="{{ asset('/images/team/1.jpg') }}" alt="member img">
                    </div><!-- /.member-img -->
                ...
                <div class="member">
                    <div class="member__img">
                    <img src="{{ asset('/images/team/2.jpg') }}" alt="member img">
                    </div><!-- /.member-img -->
                    <div class="member__info">
                ...
                <div class="member">
                    <div class="member__img">
                    <img src="{{ asset('/images/team/3.jpg') }}" alt="member img">
                    </div><!-- /.member-img -->
                    <div class="member__info">
                ...
                <div class="member">
                    <div class="member__img">
                    <img src="{{ asset('/images/team/4.jpg') }}" alt="member img">
                    </div><!-- /.member-img -->
                    <div class="member__info">
                ...
                <div class="member">
                    <div class="member__img">
                    <img src="{{ asset('/images/team/5.jpg') }}" alt="member img">
                    </div><!-- /.member-img -->
                    <div class="member__info">
                ...
                <div class="member">
                    <div class="member__img">
                    <img src="{{ asset('/images/team/6.jpg') }}" alt="member img">
                    </div><!-- /.member-img -->
                    <div class="member__info">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="slider-nav mb-60">
                    ...
                    <div class="testimonial__meta">
                    <div class="testimonial__thmb">
                        <img src="{{ asset('/images/testimonials/thumbs/2.png') }}" alt="author thumb">
                    </div><!-- /.testimonial-thumb -->
                    <div>
                    ...
                    <div class="testimonial__meta">
                    <div class="testimonial__thmb">
                        <img src="{{ asset('/images/testimonials/thumbs/3.png') }}" alt="author thumb">
                    </div><!-- /.testimonial-thumb -->
                    <div>
    ...
    <section class="gallery pt-0 pb-90">
        <div class="container">
            ...
            <div class="col-12">
                ...
                <a class="popup-gallery-item" href="{{ asset('/images/gallery/1.jpg') }}">
                    <img src="{{ asset('/images/gallery/1.jpg') }}" alt="gallery img">
                </a>
                <a class="popup-gallery-item" href="{{ asset('/images/gallery/2.jpg') }}">
                    <img src="{{ asset('/images/gallery/2.jpg') }}" alt="gallery img">
                </a>
                <a class="popup-gallery-item" href="{{ asset('/images/gallery/3.jpg') }}">
                    <img src="{{ asset('/images/gallery/3.jpg') }}" alt="gallery img">
                </a>
                <a class="popup-gallery-item" href="{{ asset('/images/gallery/4.jpg') }}">
                    <img src="{{ asset('/images/gallery/4.jpg') }}" alt="gallery img">
                </a>
                <a class="popup-gallery-item" href="{{ asset('/images/gallery/5.jpg') }}">
                    <img src="{{ asset('/images/gallery/5.jpg') }}" alt="gallery img">
                </a>
                <a class="popup-gallery-item" href="{{ asset('/images/gallery/6.jpg') }}">
                    <img src="{{ asset('/images/gallery/6.jpg') }}" alt="gallery img">
                </a>
    ...
    <section class="contact-layout3 bg-overlay bg-overlay-primary-gradient pb-60">
        <div class="bg-img"><img src="{{ asset('/images/banners/3.jpg') }}" alt="banner"></div>
        <div class="container">
            <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-7">
                <div class="contact-panel mb-50">
                <form class="contact-panel__form" method="post" action="{{ asset('/php/contact.php') }}" id="contactForm">
                    <div class="row">
                    <div class="col-sm-12">
        ...
        <div class="container">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="post__img">
                    ...
                    <img src="{{ asset('/images/blog/grid/1.jpg') }}" alt="post image" loading="lazy">
                    </a>
                </div><!-- /.post__img -->
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="post__img">
                    <a href="blog-single-post.html">
                    <img src="{{ asset('/images/blog/grid/2.jpg') }}" alt="post image" loading="lazy">
                    </a>
                </div><!-- /.post__img -->
                <div class="post__body">
                    <div class="post__meta-cat">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="post__img">
                    <a href="blog-single-post.html">
                    <img src="{{ asset('/images/blog/grid/3.jpg') }}" alt="post image" loading="lazy">
                    </a>
                </div><!-- /.post__img -->
                <div class="post__body">
                    <div class="post__meta-cat">
