...
<head>
<title>@yield('title') | Admin Company Profile</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
<meta name="description" content="Iconic Bootstrap 4.5.0 Admin Template">
<meta name="author" content="Admin Company Profile, {{ $provider->title }}">
<link rel="icon" href="{{ asset('/storage/' . $provider->logo) }}" type="image/x-icon">
...
<div id="wrapper" class="theme-cyan">
    ...
    <div class="page-loader-wrapper">
        <div class="loader">
            <div class="m-t-30"><img src="{{ asset('/storage/' . $provider->logo) }}" width="48" height="48" alt="{{ $provider->title }}"></div>
            <p>Please wait...</p>
        </div>
    </div>
    ...
    <div id="left-sidebar" class="sidebar">
        ...
        <div class="sidebar-scroll">
            <div class="user-account">
                <img src="{{ asset('/admin/images/user.png') }}" class="rounded-circle user-photo" alt="User Profile Picture">
                <div class="dropdown">
                    <span>Welcome,</span>
            ...
            <div class="tab-content padding-0">
                    ...
                    <nav id="left-sidebar-nav" class="sidebar-nav">
                        <ul class="metismenu li_animation_delay">
                            <li class="active"><a href="javascript:void(0);" class="has-arrow"><i class="fa fa-dashboard"></i><span>Dashboard</span></a>
                                <ul>
                                    <li class="active"><a href="index.html">Hospital Analytics</a></li>
                                    <li><a href="index-covid.html">Covid-19</a></li>
                                </ul>
                            </li>
                            ...
                            <li><a href="javascript:void(0);" class="has-arrow"><i class="fa fa-building"></i><span>Room Allotment</span></a>
                                <ul>
                                    <li><a href="room-all.html">View Rooms</a></li>
                                    <li><a href="room-add.html">Add Rooms</a></li>
                                </ul>
                            </li>
                            ...
                            <li><a href="javascript:void(0);" class="has-arrow"><i class="fa fa-globe"></i><span>Blog</span></a>
                                <ul>
                            ...
                            <li><a href="our-centres.html"><i class="fa fa-map"></i>WorldWide Centres</a></li>
                            <li>
                ...
                <div class="tab-pane" id="Chat">
                    ...
                    <ul class="right_chat list-unstyled li_animation_delay">
                        ...
                        <li>
                            <a href="javascript:void(0);" class="media">
                                <img class="media-object" src="{{ asset('/admin/images/xs/avatar6.jpg') }}" alt="">
                                <div class="media-body">
                                    <span class="name d-flex justify-content-between">Dr. Isabella <i class="fa fa-heart-o font-12"></i></span>
                                    <span class="message">Isabella@gmail.com</span>
                                </div>
                        ...
                        <li>
                            <a href="javascript:void(0);" class="media">
                                <img class="media-object" src="{{ asset('/admin/images/xs/avatar7.jpg') }}" alt="">
                                <div class="media-body">
                                    <span class="name d-flex justify-content-between">Dr. Folisise Chosielie <i class="fa fa-heart font-12"></i></span>
                                    <span class="message">FolisiseChosielie@gmail.com</span>
                                </div>
                            ...
                            <div class="table-responsive table_middel">
                                <table class="table m-b-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td><img src="{{ asset('/admin/images/xs/avatar3.jpg') }}" class="rounded-circle avatar mr-2" alt="profile-image"><span>John</span></td>
                                        ...
                                        <tr>
                                            <td>2</td>
                                            <td><img src="{{ asset('/admin/images/xs/avatar1.jpg') }}" class="rounded-circle avatar mr-2" alt="profile-image"><span>Jack Bird</span></td>
                                        ...
                                        <tr>
                                            <td>3</td>
                                            <td><img src="{{ asset('/admin/images/xs/avatar4.jpg') }}" class="rounded-circle avatar mr-2" alt="profile-image"><span>Dean Otto</span></td>
                                            <td><span class="text-info">123 6th St. Melbourne, FL 32904</span></td>
                                            <td>Sept 13, 2017</td>
                                            <td>Sept 23, 2017</td>
                                            <td><span class="badge badge-warning">MEDIUM</span></td>
                                        ...
                                        <tr>
                                            <td>4</td>
                                            <td><img src="{{ asset('/admin/images/xs/avatar2.jpg') }}" class="rounded-circle avatar mr-2" alt="profile-image"><span>Jack Bird</span></td>
                                        ...
                                        <tr>
                                            <td>5</td>
                                            <td><img src="{{ asset('/admin/images/xs/avatar5.jpg') }}" class="rounded-circle avatar mr-2" alt="profile-image"><span>Hughe L.</span></td>
                                            <td><span class="text-info">4 Shirley Ave. West Chicago, IL 60185</span></td>
                                            <td>Sept 18, 2017</td>
                                            <td>Sept 18, 2017</td>
