...
<head>
	...
	<title>419 - Bridging Satu Sehat LAWU</title>
</head>
					...
					<div class="row g-0">
						<div class="col col-xl-5">
							<div class="card-body p-4">
								<h1 class="display-1"><span class="text-primary">4</span><span class="text-danger">1</span><span class="text-success">9</span></h1>
								<h2 class="font-weight-bold display-4">Halaman sudah kadaluarsa.</h2>
