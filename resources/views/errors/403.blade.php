...
<head>
	...
	<title>403 - Bridging Satu Sehat LAWU</title>
</head>
					...
					<div class="row g-0">
						<div class="col col-xl-5">
							<div class="card-body p-4">
								...
								<h2 class="font-weight-bold display-4">Anda Tidak memiliki Akses</h2>
						...
						<div class="col-xl-7">
							<img src="{{ asset('/images/errors-images/403-error.png') }}" class="img-fluid" alt="">
						</div>
					</div>
					<!--end row-->
				</div>
